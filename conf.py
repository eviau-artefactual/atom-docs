...
# sphinx-quickstart on Tue Jul 16 19:48:18 2013.
#
...
# Load extlinks dictionary from links/link.py
sys.path.append(".")
...
latex_documents = [
    ("index", "AtoM.tex", "AtoM Documentation", "Artefactual Systems Inc.", "manual"),
]
...
man_pages = [("index", "atom", "AtoM Documentation", ["Artefactual Systems Inc."], 1)]
...
texinfo_documents = [
    (
        ...
        "AtoM",
        "An open source archival description and access system.",
        "Miscellaneous",
    ),
]
